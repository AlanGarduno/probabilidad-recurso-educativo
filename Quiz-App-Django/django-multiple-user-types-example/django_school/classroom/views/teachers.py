...
class QuizCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        quiz.save()
        messages.success(self.request, 'El cuestionario se creo correctamente')
...
class QuizDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        messages.success(request, 'El cuestionario %s ha sido eliminado!' % quiz.name)
...
def question_add(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            question.quiz = quiz
            question.save()
            messages.success(request, 'Se agrego la pregunta')
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and formset.is_valid():
            with transaction.atomic():
                form.save()
                formset.save()
            messages.success(request, 'Preguntas y respuestas se guardaron correctamente!')
            return redirect('teachers:quiz_change', quiz.pk)
    else:
...
class QuestionDeleteView(DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        question = self.get_object()
        messages.success(request, 'La pregunta %s se elimino correctamente!' % question.text)
        return super().delete(request, *args, **kwargs)
